 ...
 */
gulp.task( 'clean:pot', () =>
	del( [ 'languages/advanced-maps-block.pot' ] )
);
...
gulp.task( 'wp-pot', [ 'clean:pot' ], () =>
	gulp.src( paths.php )
		...
		.pipe( sort() )
		.pipe( wpPot( {
			'domain': 'advanced-maps-block',
			'package': 'advanced-maps-block'
		} ) )
		.pipe( gulp.dest( 'languages/advanced-maps-block.pot' ) )
);
...
gulp.task( 'watch', function() {
	...
	browserSync( {
		...
		'proxy': 'https://wds.test', // Use https://Advanced Maps Block.test:3000 to use BrowserSync.
		'watchOptions': {
