 ...
 */
function amb_site_display_scaffolding_section( $args = array() ) {
	...
	$allowed_tags = amb_site_scaffolding_allowed_html();
	...
	<div class="scaffolding-document <?php echo esc_attr( $class ); ?>">
		...
		<header class="scaffolding-document-header display-flex flex-start space-between">
			...
			<button type="button" class="scaffolding-button"><?php esc_html_e( 'Details', 'advanced-maps-block' ); ?></button>
		...
		<div class="scaffolding-document-content">
			...
			<?php if ( $args['description'] ) : ?>
				<p><strong><?php esc_html_e( 'Description', 'advanced-maps-block' ); ?>:</strong></p>
				<p class="scaffolding-document-description"><?php echo esc_html( $args['description'] ); ?></p>
			<?php endif; ?>

			<?php if ( $args['parameters'] ) : ?>
				<p><strong><?php esc_html_e( 'Parameters', 'advanced-maps-block' ); ?>:</strong></p>
			...
			<?php if ( $args['arguments'] ) : ?>
				<p><strong><?php esc_html_e( 'Arguments', 'advanced-maps-block' ); ?>:</strong></p>
			...
			<?php if ( $args['usage'] ) : ?>
				<p><strong><?php esc_html_e( 'Usage', 'advanced-maps-block' ); ?>:</strong></p>
				<pre><?php echo esc_html( $args['usage'] ); ?></pre>
			<?php endif; ?>

			<?php if ( $args['output'] ) : ?>
				<p><strong><?php esc_html_e( 'HTML Output', 'advanced-maps-block' ); ?>:</strong></p>
 ...
 * @author Carrie Forde
 */
function amb_site_scaffolding_allowed_html() {
 ...
 * @author Carrie Forde
 */
function amb_site_display_global_scaffolding_section( $args = array() ) {
 ...
 * @author Carrie Forde
 */
function amb_site_hook_theme_scaffolding() {
...
add_action( 'amb_site_scaffolding_content', 'amb_site_hook_theme_scaffolding' );
