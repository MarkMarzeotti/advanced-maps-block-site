...
( function( window, $, app ) {
	...
	app.cache = function() {
		app.$c = {
			window: $( window ),
			headerButtonSelect: $( '#customize-control-amb_site_header_button select' ),
			headerLinkButton: $( '#customize-control-amb_site_header_button_url' ),
			headerLinkText: $( '#customize-control-amb_site_header_button_text' )
		};
	};
