...
<section class="section-scaffolding">
	...
	<h2 class="scaffolding-heading"><?php esc_html_e( 'Typography', 'advanced-maps-block' ); ?></h2>
	...
	amb_site_display_scaffolding_section(
		array(
			...
			'usage'       => '<del>Advanced Maps Block</del>',
			'output'      => '<p>We use <del>Advanced Maps Block</del> wd_s to build themes.</p>',
		)
	);
